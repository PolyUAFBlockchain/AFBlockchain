package edu.polyu.af.blockchain.associate.contracts;

import edu.polyu.af.blockchain.core.contracts.TemplateContract;
import edu.polyu.af.blockchain.core.states.TemplateState;
...
public class ContractTests {
    ...
    public void issuerAndRecipientCannotHaveSameEmail() {
        ...
        ledger(ledgerServices, l -> {
            l.transaction(tx -> {
                tx.input(edu.polyu.af.blockchain.core.contracts.TemplateContract.ID, state);
                tx.output(edu.polyu.af.blockchain.core.contracts.TemplateContract.ID, state);
                tx.command(alice.getPublicKey(), new edu.polyu.af.blockchain.core.contracts.TemplateContract.Commands.Send());
